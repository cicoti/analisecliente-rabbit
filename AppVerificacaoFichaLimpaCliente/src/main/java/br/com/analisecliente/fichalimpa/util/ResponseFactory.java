package br.com.analisecliente.fichalimpa.util;

import java.time.LocalDateTime;

import br.com.analisecliente.fichalimpa.dto.ResponsePadrao;
import br.com.analisecliente.fichalimpa.dto.RetornoPadrao;
...
public class ResponseFactory {
    ...
    public static ResponsePadrao erro(Object dados, int codigo, String chave, String mensagem, String detalhe) {
        RetornoPadrao retorno = new RetornoPadrao();
