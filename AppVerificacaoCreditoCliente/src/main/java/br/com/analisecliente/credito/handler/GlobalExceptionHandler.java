package br.com.analisecliente.credito.handler;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ResponsePadrao> handleErroGenerico(Exception ex) {
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(ResponseFactory.erro(null, -1, "ERRO_SISTEMICO", "Erro sistêmico", "Erro interno ao processar a solicitação Detalhe:"));
    }
}